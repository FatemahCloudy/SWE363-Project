...
import SharedMemoriesPage from "@/pages/shared-memories";
import SharedGroupPage from "@/pages/shared-group";
...
function Router() {
    return (
        <Switch>
            ...
            <Route path="/shared-memories">
                {() => <ProtectedRoute component={SharedMemoriesPage} />}
            </Route>
            <Route path="/shared-memories/:groupId">
                {() => <ProtectedRoute component={SharedGroupPage} />}
            </Route>
